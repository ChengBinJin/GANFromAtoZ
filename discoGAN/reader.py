...
class Reader(object):
    def __init__(self, tfrecords_file, image_size=(256, 256, 1), min_queue_examples=100, batch_size=1, num_threads=8,
                 name=''):
    ...
    def _preprocess(self, image):
        ...
        image = (tf.image.convert_image_dtype(image, dtype=tf.float32) / 127.5) - 1.0  # [-1, 1]
