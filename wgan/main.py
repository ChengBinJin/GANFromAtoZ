...
tf.flags.DEFINE_float('clip_val', 0.01, 'clipping value for Lipschitz constrain of the WGAN, default: 0.01')
...
tf.flags.DEFINE_integer('sample_freq', 250, 'sample frequency for saving image, default: 250')
